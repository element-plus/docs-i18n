...
:::demo 默认日期选择器范围有两个面板。 如果你想要一个面板设置 `single-panel` 属性。
...
| show-footer ^(2.10.5)        | whether to show footer where the date picker is one ^[enum]`'dates' \| 'months' \| 'years' \| 'quarters'` | ^[boolean]                                                                                                                                                                                                                | true                               |
