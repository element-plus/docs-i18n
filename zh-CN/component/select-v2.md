...
| filter-method                         | 自定义筛选方法的第一个参数是当前输入的值。 当`filterable`设置为 true 时才会生效                                                          | ^[Function]`(query: string) => void`                                                                                                                                                | —                                              |
...
| estimated-option-height               | 控制虚拟列表大小模式：如果未定义，则列表使用来自 `item-height` 的固定项目高度；如果提供，则列表使用动态项目大小，并将此值作为估计的项目高度。                             | ^[number]                                                                                                                                                                              | —                                              |
