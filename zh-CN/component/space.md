...
虽然我们拥有 [Divider 组件](./divider.md)，但很多时候我们需要不是一个被 [Divider 组件](./divider.md) 分割开的页面结构，因此我们会重复的使用很多的 [Divider 组件](./divider.md)，这在我们的开发效率上造成了一定的困扰。 **间距组件**就是为了解决这种困扰应运而生的。
