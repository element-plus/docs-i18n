...
:::demo 启用后，只能选择文件夹；选择文件夹后，文件夹内的文件将被扁平化处理。
...
| file-list / v-model:file-list | 默认上传文件                                                                                                            | ^[array]`UploadUserFile[]`                                                                                                                                                   | []                                                                                                                |
...
| 名称           | 描述                                                        | 类型                                                                                    |
| ------------ | --------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| abort        | 取消上传请求。 当指定了文件时，中止相应的待上传文件；当未指定文件时，中止所有待上传文件。             | ^[Function]`(file?: UploadFile) => void`                                           |
