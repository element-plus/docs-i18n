...
:::demo 将 `virtual-scroll` 设置为 `true` 以启用虚拟滚动。 您也可以使用 `item-size` 自定义项的高度。 默认项大小为 30px。
...
| 属性名                         | 说明                                                                                       | 类型                                                                          | 默认值      |
| --------------------------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | -------- |
| model-value / v-model       | 选中项绑定值                                                                                   | ^[array]`Array<string \| number>`                                    | []       |
| data                        | Transfer 的数据源                                                                            | ^[array]`Record<string, any>[]`                                       | []       |
...
| titles                      | 自定义列表标题                                                                                  | ^[array]`[string, string]`                                                  | []       |
| button-texts                | 自定义按钮文案                                                                                  | ^[array]`[string, string]`                                                  | []       |
| render-content              | 自定义数据项渲染函数                                                                               | ^[object]`renderContent`                                                    | —        |
| format                      | 列表顶部勾选状态文案                                                                               | ^[object]`TransferFormat`                                                   | {}       |
| [props](#type-declarations) | 数据源的字段别名                                                                                 | ^[object]`TransferPropsAlias`                                               | —        |
| left-default-checked        | 初始状态下左侧列表的已勾选项的 key 数组                                                                   | ^[array]`Array<string \| number>`                                    | []       |
| right-default-checked       | 初始状态下右侧列表的已勾选项的 key 数组                                                                   | ^[array]`Array<string \| number>`                                    | []       |
| validate-event              | 是否触发表单验证                                                                                 | ^[boolean]                                                                  | true     |
| virtual-scroll ^(2.14.3)    | 是否为大数据启用虚拟滚动                                                                             | ^[boolean]                                                                  | false    |
| item-size ^(2.14.3)         | 虚拟滚动的节点高度 (px)                                                                           | ^[number]                                                                   | 30       |
...
| 插槽名                  | 说明                    | 类型                                      |
| -------------------- | --------------------- | --------------------------------------- |
| default              | 自定义数据项的内容，            | ^[object]`{ option: TransferDataItem }` |
