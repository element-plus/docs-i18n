...
| hue-slider-class ^(2.13.6) | 类名将会传递给 hue-slider | ^[object]`string \| string[] \| Record<string, boolean>`                                              | :::                                                                              |
| hue-slider-style ^(2.13.6) | 样式将会传递给 hue-slider | ^[string] / ^[object]`StyleValue`                 | :::                                                                              |
