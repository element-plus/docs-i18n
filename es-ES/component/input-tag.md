...
| collapse-tags ^(2.11.0)         | si contraer etiquetas a un texto con la selección múltiple                                                                                                           | ^[boolean]                                                                                 | false       |
| collapse-tags-tooltip ^(2.11.0) | si se muestran todas las etiquetas seleccionadas al pasar el ratón por el texto de las etiquetas colapsadas. To use this, collapse-tags must be true | ^[boolean]                                                                                 | false       |
