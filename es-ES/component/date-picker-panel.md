...
| tipo                                                                      | type of the picker. `quarter`, `quarters`, and `quarterrange` are supported since ^(2.14.5)                                 | ^[enum]`'year' \| 'years' \|'month' \| 'months' \| 'date' \| 'dates' \| 'datetime' \| 'week' \| 'quarter' \| 'quarters' \| 'datetimerange' \| 'daterange' \| 'monthrange' \| 'yearrange' \| 'quarterrange'`                            | date                                                   |
...
| show-footer                                                               | whether to show footer where the date picker is one ^[enum]`'dates' \| 'months' \| 'years' \| 'quarters' \| 'datetime' \| 'datetimerange'` | ^[boolean]                                                                                                                                                                                                                             | false                                                  |
